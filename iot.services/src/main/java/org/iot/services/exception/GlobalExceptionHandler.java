...
public class GlobalExceptionHandler  {
	...
	public ResponseEntity<?> resourceAlreadyExistsHandling(ElementAlreadyExistsException exception, WebRequest request) {
		logger.warn(exception.getClazz().toString() +" - "+ exception.getClass() 
	...
	public ResponseEntity<?> globalExceptionHandling(ServiceException exception, WebRequest request) {
		logger.error(exception.getClazz().toString() +" - "+ exception.getClass() 
